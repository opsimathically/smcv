...
| HTTP/runtime | `axum 0.8.9`, `tower 0.5.3`, `tower-http 0.7.0`, `tokio 1.53.1` | Narrow HTTP/1, JSON, multipart, static-file, timeout, trace, signal, and bounded runtime features. | Re-run route-contract, parser limits, auth, shutdown, telemetry, browser, and artifact campaigns after upgrades. |
