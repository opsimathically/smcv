...
| SEC-001 | Negative/failure/property/parser/accessibility campaigns, the six-phase final review, and ten additional consecutive whole-project adversarial repair passes; arbitrary archives, credentials, and metadata cannot panic. [Ten-pass review](../ai_context_documentation/reviews/TEN_PASS_ADVERSARIAL_REVIEW.md), [Phase 6 review](../ai_context_documentation/reviews/FINAL_INTERNAL_ASSURANCE.md). |
