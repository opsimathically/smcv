...
| Supply chain/release | [Dependency review](../ai_context_documentation/DEPENDENCY_AND_UNSAFE_REVIEW.md), clean RustSec/license/source gates, project unsafe prohibition, seven structurally verified CycloneDX SBOMs, `Cargo.lock`, internal/outer checksums, safe extraction, clean provenance, exact target/glibc rejection, pinned CI actions/tools, secret scan, and two-build equality satisfy the candidate envelope. The ten-pass review records the OpenSSL builder/runtime ABI too. |
